...
const LUMINA_PRODUCTS = [
  {
    ...
    sizes: ['XS','S','M','L','XL'],
    description: 'Vestido de corte midi con estampado floral exclusivo de la colección Lumina 2024. Confeccionado en tela fluida de alta calidad que se adapta a la figura. Ideal para ocasiones especiales, eventos sociales y salidas nocturnas.',
...
const LUMINA_EXTENDED = {
  1: { stock: 4,  rating: 4.8, reviewCount: 47, deliveryDays: '2-3',
       reviews: [
         { name: 'Camila R.',   rating: 5, date: '12 may 2024', verified: true,  comment: 'Increíble calidad, el corte es perfecto y la tela se siente premium. Me llegó en 2 días a Guayaquil.' },
         { name: 'Valentina M.',rating: 5, date: '3 may 2024',  verified: true,  comment: 'El vestido es exactamente como en las fotos. Los colores son vibrantes y el material muy cómodo.' },
         { name: 'Sofía G.',    rating: 4, date: '28 abr 2024', verified: false, comment: 'Muy bonito aunque talla un poco grande. Recomiendo pedir una talla menos. El empaque fue muy bonito.' },
       ]},
  2: { stock: 7,  rating: 4.6, reviewCount: 32, deliveryDays: '2-4',
       reviews: [
         { name: 'Diego P.',    rating: 5, date: '18 may 2024', verified: true,  comment: 'Abrigo de excelente calidad. El oversize queda perfecto y la lana es muy cálida sin ser pesada.' },
         { name: 'Mateo L.',    rating: 4, date: '10 may 2024', verified: true,  comment: 'Muy elegante, el azul oscuro es un tono precioso. Tardó 3 días en llegar pero valió la espera.' },
         { name: 'Andrés V.',   rating: 5, date: '2 may 2024',  verified: false, comment: 'Compré para un evento y recibí muchos elogios. Definitivamente vale cada centavo.' },
       ]},
  3: { stock: 12, rating: 4.5, reviewCount: 28, deliveryDays: '2-3',
       reviews: [
         { name: 'Paula N.',    rating: 5, date: '15 may 2024', verified: true,  comment: 'El conjunto es perfecto para el día a día. Cómodo, versátil y muy estiloso. 100% recomendado.' },
         { name: 'Isabella F.', rating: 4, date: '8 may 2024',  verified: true,  comment: 'Muy buena calidad. El negro queda perfecto con todo. La entrega fue súper rápida.' },
       ]},
  4: { stock: 3,  rating: 4.9, reviewCount: 63, deliveryDays: '1-2',
       reviews: [
         { name: 'Luciana B.',  rating: 5, date: '20 may 2024', verified: true,  comment: 'Los accesorios son preciosos, el baño dorado se ve muy lujoso. Perfectos para regalar.' },
         { name: 'Ana C.',      rating: 5, date: '14 may 2024', verified: true,  comment: 'Calidad increíble por el precio. El collar estructurado es mi favorito, llevo semanas usándolo.' },
         { name: 'Daniela H.',  rating: 5, date: '7 may 2024',  verified: false, comment: 'Me los regalaron y quedé enamorada. El estuche de presentación es muy elegante también.' },
       ]},
  5: { stock: 15, rating: 4.4, reviewCount: 19, deliveryDays: '2-3',
       reviews: [
         { name: 'Rodrigo E.',  rating: 4, date: '11 may 2024', verified: true,  comment: 'Camisa de excelente calidad en lino, perfecta para el clima de la Costa. Corte muy bien logrado.' },
         { name: 'Sebastián T.',rating: 5, date: '5 may 2024',  verified: true,  comment: 'Muy fresca para el verano. El blanco es puro y el lino no arruga tanto como esperaba.' },
       ]},
  6: { stock: 5,  rating: 4.7, reviewCount: 41, deliveryDays: '2-3',
       reviews: [
         { name: 'Mariana Q.',  rating: 5, date: '19 may 2024', verified: true,  comment: 'El color coral es hermoso y la tela cae perfecto. Me lo puse para una boda y quedé preciosa.' },
         { name: 'Xiomara P.',  rating: 5, date: '13 may 2024', verified: true,  comment: 'Súper cómodo y elegante. El cierre de la espalda funciona muy bien y la talla es exacta.' },
         { name: 'Renata A.',   rating: 4, date: '6 may 2024',  verified: false, comment: 'Muy bonito aunque el naranja es un poco más intenso que en la foto. Igual me encantó.' },
       ]},
  7: { stock: 2,  rating: 4.8, reviewCount: 35, deliveryDays: '2-4',
       reviews: [
         { name: 'Carolina J.', rating: 5, date: '17 may 2024', verified: true,  comment: 'El bolso es espectacular, el cuero vegano tiene una textura premium. Cabe laptop de 13" perfectamente.' },
         { name: 'Mónica S.',   rating: 5, date: '9 may 2024',  verified: true,  comment: 'Compra impulsiva que no me arrepiento. Las asas son muy resistentes y el logo es elegante.' },
       ]},
  8: { stock: 6,  rating: 4.5, reviewCount: 22, deliveryDays: '2-3',
       reviews: [
         { name: 'Fabricio O.', rating: 5, date: '16 may 2024', verified: true,  comment: 'El look completo es de una calidad impresionante. Ideal para eventos formales, impecable el corte.' },
         { name: 'Javier M.',   rating: 4, date: '8 may 2024',  verified: false, comment: 'Muy buen conjunto, el blazer tiene un caído perfecto. Recomiendo tomarse las medidas antes.' },
       ]},
  9: { stock: 3,  rating: 4.9, reviewCount: 18, deliveryDays: '2-3',
       reviews: [
         { name: 'Gabriela Z.', rating: 5, date: '21 may 2024', verified: true,  comment: 'El bordado artesanal es una obra de arte. Nunca había visto algo así en e-commerce ecuatoriano.' },
         { name: 'Natalia K.',  rating: 5, date: '15 may 2024', verified: true,  comment: 'Pieza única, el crepé de china cae perfectamente. Muchos me preguntaron dónde lo compré.' },
       ]},
  10:{ stock: 8,  rating: 4.6, reviewCount: 55, deliveryDays: '2-3',
       reviews: [
         { name: 'Priscila C.', rating: 5, date: '22 may 2024', verified: true,  comment: 'El set es ideal para el verano, la tela es muy fresca y el corte favorece muchísimo.' },
         { name: 'Fernanda R.', rating: 4, date: '16 may 2024', verified: true,  comment: 'Muy buen precio por la calidad. El rojo coral es precioso, llegó en excelentes condiciones.' },
         { name: 'Valeria N.',  rating: 5, date: '10 may 2024', verified: false, comment: 'Compré para la playa y fue un éxito total. El top con soporte integrado es muy cómodo.' },
       ]},
  11:{ stock: 9,  rating: 4.4, reviewCount: 44, deliveryDays: '2-4',
       reviews: [
         { name: 'Emilio T.',   rating: 4, date: '14 may 2024', verified: true,  comment: 'Jean de muy buena calidad, el efecto vintage se ve natural y el elastano le da mucha comodidad.' },
         { name: 'Cristian V.', rating: 5, date: '7 may 2024',  verified: true,  comment: 'El mejor jean que he comprado por internet. El corte slim es perfecto, no aprieta las piernas.' },
       ]},
  12:{ stock: 2,  rating: 4.8, reviewCount: 29, deliveryDays: '2-4',
       reviews: [
         { name: 'Alessandra P.',rating: 5, date: '23 may 2024', verified: true,  comment: 'Edición especial que vale la pena. El diseño geométrico es único y la cadena dorada es preciosa.' },
         { name: 'Renata V.',   rating: 5, date: '17 may 2024', verified: true,  comment: 'Bolso de piezas numeradas, llegó con certificado. El cuero genuino es de primera calidad.' },
       ]},
};
